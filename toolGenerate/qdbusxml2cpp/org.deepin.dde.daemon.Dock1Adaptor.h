...
#include "./dde-clipboard/toolGenerate/qdbusxml2cpp/org.lingmo.daemon.Dock1.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface org.lingmo.daemon.Dock1
 */
class Dock1Adaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.lingmo.daemon.Dock1")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"org.lingmo.daemon.Dock1\">\n"
